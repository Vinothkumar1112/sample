...
Feature: Provider Portal: Forgot Password - User validation success
  ...
  @Regression
  @Sprint2
  Scenario Outline: EPIC_EPP-121_STORY_EPP-245-Verify that Referring provider should not receive the link when the user provides invalid email
    ...
    And user should not receive password reset link to their registered email
